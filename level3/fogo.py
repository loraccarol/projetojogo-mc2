...
change = pygame.image.load("level3/assets/lampGrey.png")
change = pygame.transform.scale(change, (200, 200))
...
while levelActive:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            print(pos)
            if 80 < pos[0] < 200 and 89 < pos[1] < 272:  # lamp
                trashA.remove(lamp)
                trashA.insert(0, change)'''
